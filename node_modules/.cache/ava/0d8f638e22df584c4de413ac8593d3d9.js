...
function permuteArray(array) {
    console.log('permuteArray: ', array);
    switch (array.length) {
        case 0:
            return [];
        case 1:
        ...
        */
        default:
            return flatten(array.map(a => {
                console.log('permuteArray ', permuteArray(without(array, a)).map(b => {
...
//# sourceMappingURL=/Users/mac/WebstormProjects/interview/node_modules/.cache/ava/0d8f638e22df584c4de413ac8593d3d9.js.map