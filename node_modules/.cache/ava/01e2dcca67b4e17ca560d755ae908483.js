...
(0, _ava.test)(async t => {
    let a = Promise.resolve('a');
    let b = Promise.resolve('b');
    let c = new Promise(resolve => setTimeout(() => {
        resolve('c');
    }, 500));
    t.deepEqual(['a', 'b', 'c'], reduceAsync([a, b, c], (acc, curr) => [...acc, curr], []));
});
//# sourceMappingURL=/Users/mac/WebstormProjects/interview/node_modules/.cache/ava/01e2dcca67b4e17ca560d755ae908483.js.map