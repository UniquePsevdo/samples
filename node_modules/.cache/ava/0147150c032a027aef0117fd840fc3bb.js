...
function isPrime(val) {
    ...
    for (let i = 0; i < Math.ceil(Math.sqrt(val)) + 1; i++) {
        if (val % i === 0 && i !== val) {
            return false;
        }
    }
...
(0, _ava.test)('4 is not a prime number', t => {
    var _rec = new _powerAssertRecorder();

    return t.falsy(_rec._expr(_rec._capt(isPrime(4), 'arguments/0'), {
        content: 't.falsy(isPrime(4))',
        filepath: 'easy/isPrime.js',
        line: 87,
        ast: '{"type":"CallExpression","callee":{"type":"MemberExpression","object":{"type":"Identifier","name":"t","range":[0,1]},"property":{"type":"Identifier","name":"falsy","range":[2,7]},"computed":false,"range":[0,7]},"arguments":[{"type":"CallExpression","callee":{"type":"Identifier","name":"isPrime","range":[8,15]},"arguments":[{"type":"NumericLiteral","value":4,"range":[16,17]}],"range":[8,18]}],"range":[0,19]}',
        tokens: '[{"type":{"label":"name"},"value":"t","range":[0,1]},{"type":{"label":"."},"range":[1,2]},{"type":{"label":"name"},"value":"falsy","range":[2,7]},{"type":{"label":"("},"range":[7,8]},{"type":{"label":"name"},"value":"isPrime","range":[8,15]},{"type":{"label":"("},"range":[15,16]},{"type":{"label":"num"},"value":4,"range":[16,17]},{"type":{"label":")"},"range":[17,18]},{"type":{"label":")"},"range":[18,19]}]',
        visitorKeys: _powerAssertVisitorKeys
    }));
});
(0, _ava.test)('13 is a prime number', t => {
    var _rec2 = new _powerAssertRecorder();

    return t.truthy(_rec2._expr(_rec2._capt(isPrime(13), 'arguments/0'), {
        content: 't.truthy(isPrime(13))',
        filepath: 'easy/isPrime.js',
        line: 88,
        ast: '{"type":"CallExpression","callee":{"type":"MemberExpression","object":{"type":"Identifier","name":"t","range":[0,1]},"property":{"type":"Identifier","name":"truthy","range":[2,8]},"computed":false,"range":[0,8]},"arguments":[{"type":"CallExpression","callee":{"type":"Identifier","name":"isPrime","range":[9,16]},"arguments":[{"type":"NumericLiteral","value":13,"range":[17,19]}],"range":[9,20]}],"range":[0,21]}',
        tokens: '[{"type":{"label":"name"},"value":"t","range":[0,1]},{"type":{"label":"."},"range":[1,2]},{"type":{"label":"name"},"value":"truthy","range":[2,8]},{"type":{"label":"("},"range":[8,9]},{"type":{"label":"name"},"value":"isPrime","range":[9,16]},{"type":{"label":"("},"range":[16,17]},{"type":{"label":"num"},"value":13,"range":[17,19]},{"type":{"label":")"},"range":[19,20]},{"type":{"label":")"},"range":[20,21]}]',
        visitorKeys: _powerAssertVisitorKeys
    }));
});
//# sourceMappingURL=/Users/mac/WebstormProjects/interview/node_modules/.cache/ava/0147150c032a027aef0117fd840fc3bb.js.map