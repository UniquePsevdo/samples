...
function binarySearch(arr, val) {
    ...
    while (min < max) {
        guess = Math.floor(min + max);
        if (arr[guess] === val) {
            return guess;
        } else if (val < arr[guess]) {
            min = guess + 1;
        } else {
            max = guess - 1;
        }
...
//# sourceMappingURL=/Users/mac/WebstormProjects/interview/node_modules/.cache/ava/1de4a8228709bf92b4a8f8cda0ba905d.js.map