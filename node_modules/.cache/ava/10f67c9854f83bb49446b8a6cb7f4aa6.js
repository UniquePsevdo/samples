...
function isPalindrome(str) {
    ...
    for (let i = 0; i < strArr.length; i++) {
        if (strArr[i] !== strArr[arr.length - 1 - i]) {
            return false;
        }
    }
    return true;
...
(0, _ava.test)('palindrome is false 1023321', t => {
    var _rec = new _powerAssertRecorder();

    return t.falsy(_rec._expr(_rec._capt(isPalindrome('1023321'), 'arguments/0'), {
        content: 't.falsy(isPalindrome(\'1023321\'))',
        filepath: 'easy/isPalindrome.js',
        line: 13,
        ast: '{"type":"CallExpression","callee":{"type":"MemberExpression","object":{"type":"Identifier","name":"t","range":[0,1]},"property":{"type":"Identifier","name":"falsy","range":[2,7]},"computed":false,"range":[0,7]},"arguments":[{"type":"CallExpression","callee":{"type":"Identifier","name":"isPalindrome","range":[8,20]},"arguments":[{"type":"StringLiteral","value":"1023321","range":[21,30]}],"range":[8,31]}],"range":[0,32]}',
        tokens: '[{"type":{"label":"name"},"value":"t","range":[0,1]},{"type":{"label":"."},"range":[1,2]},{"type":{"label":"name"},"value":"falsy","range":[2,7]},{"type":{"label":"("},"range":[7,8]},{"type":{"label":"name"},"value":"isPalindrome","range":[8,20]},{"type":{"label":"("},"range":[20,21]},{"type":{"label":"string"},"value":"1023321","range":[21,30]},{"type":{"label":")"},"range":[30,31]},{"type":{"label":")"},"range":[31,32]}]',
        visitorKeys: _powerAssertVisitorKeys
    }));
});
(0, _ava.test)('palindrome is true 123321', t => {
    var _rec2 = new _powerAssertRecorder();

    return t.truthy(_rec2._expr(_rec2._capt(isPalindrome('123321'), 'arguments/0'), {
        content: 't.truthy(isPalindrome(\'123321\'))',
        filepath: 'easy/isPalindrome.js',
        line: 14,
        ast: '{"type":"CallExpression","callee":{"type":"MemberExpression","object":{"type":"Identifier","name":"t","range":[0,1]},"property":{"type":"Identifier","name":"truthy","range":[2,8]},"computed":false,"range":[0,8]},"arguments":[{"type":"CallExpression","callee":{"type":"Identifier","name":"isPalindrome","range":[9,21]},"arguments":[{"type":"StringLiteral","value":"123321","range":[22,30]}],"range":[9,31]}],"range":[0,32]}',
        tokens: '[{"type":{"label":"name"},"value":"t","range":[0,1]},{"type":{"label":"."},"range":[1,2]},{"type":{"label":"name"},"value":"truthy","range":[2,8]},{"type":{"label":"("},"range":[8,9]},{"type":{"label":"name"},"value":"isPalindrome","range":[9,21]},{"type":{"label":"("},"range":[21,22]},{"type":{"label":"string"},"value":"123321","range":[22,30]},{"type":{"label":")"},"range":[30,31]},{"type":{"label":")"},"range":[31,32]}]',
        visitorKeys: _powerAssertVisitorKeys
    }));
});
//# sourceMappingURL=/Users/mac/WebstormProjects/interview/node_modules/.cache/ava/10f67c9854f83bb49446b8a6cb7f4aa6.js.map