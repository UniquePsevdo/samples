...
(0, _ava.test)(t => {
    ...
    return t.truthy(_rec._expr(_rec._capt(isBalanced('(foo { bar (baz) [boo] })'), 'arguments/0'), {
        content: 't.truthy(isBalanced(\'(foo { bar (baz) [boo] })\'))',
        filepath: 'middle/isBalanced.js',
        line: 48,
        ast: '{"type":"CallExpression","callee":{"type":"MemberExpression","object":{"type":"Identifier","name":"t","range":[0,1]},"property":{"type":"Identifier","name":"truthy","range":[2,8]},"computed":false,"range":[0,8]},"arguments":[{"type":"CallExpression","callee":{"type":"Identifier","name":"isBalanced","range":[9,19]},"arguments":[{"type":"StringLiteral","value":"(foo { bar (baz) [boo] })","range":[20,47]}],"range":[9,48]}],"range":[0,49]}',
        tokens: '[{"type":{"label":"name"},"value":"t","range":[0,1]},{"type":{"label":"."},"range":[1,2]},{"type":{"label":"name"},"value":"truthy","range":[2,8]},{"type":{"label":"("},"range":[8,9]},{"type":{"label":"name"},"value":"isBalanced","range":[9,19]},{"type":{"label":"("},"range":[19,20]},{"type":{"label":"string"},"value":"(foo { bar (baz) [boo] })","range":[20,47]},{"type":{"label":")"},"range":[47,48]},{"type":{"label":")"},"range":[48,49]}]',
...
(0, _ava.test)(t => {
    ...
    return t.falsy(_rec2._expr(_rec2._capt(isBalanced('foo { bar { baz }'), 'arguments/0'), {
        content: 't.falsy(isBalanced(\'foo { bar { baz }\'))',
        filepath: 'middle/isBalanced.js',
        line: 49,
        ast: '{"type":"CallExpression","callee":{"type":"MemberExpression","object":{"type":"Identifier","name":"t","range":[0,1]},"property":{"type":"Identifier","name":"falsy","range":[2,7]},"computed":false,"range":[0,7]},"arguments":[{"type":"CallExpression","callee":{"type":"Identifier","name":"isBalanced","range":[8,18]},"arguments":[{"type":"StringLiteral","value":"foo { bar { baz }","range":[19,38]}],"range":[8,39]}],"range":[0,40]}',
        tokens: '[{"type":{"label":"name"},"value":"t","range":[0,1]},{"type":{"label":"."},"range":[1,2]},{"type":{"label":"name"},"value":"falsy","range":[2,7]},{"type":{"label":"("},"range":[7,8]},{"type":{"label":"name"},"value":"isBalanced","range":[8,18]},{"type":{"label":"("},"range":[18,19]},{"type":{"label":"string"},"value":"foo { bar { baz }","range":[19,38]},{"type":{"label":")"},"range":[38,39]},{"type":{"label":")"},"range":[39,40]}]',
        visitorKeys: _powerAssertVisitorKeys
    }));
});
//# sourceMappingURL=/Users/mac/WebstormProjects/interview/node_modules/.cache/ava/7e2e3cd6a44af378e754cc65b8ee63d7.js.map